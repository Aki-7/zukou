...
#include "sphere-geometry.frag.h"
#include "sphere-geometry.geom.h"
#include "sphere-geometry.vert.h"
...
Sphere::Init()
{
  ...
  const char* fragment_shader_source =
      wire_ ? color_fragment_shader_source
            : sphere_geometry_fragment_shader_source;
  ...
  if (!vertex_shader_.Init(
          GL_VERTEX_SHADER, sphere_geometry_vertex_shader_source))
    return false;
  if (!geometry_shader_.Init(
          GL_GEOMETRY_SHADER, sphere_geometry_geometry_shader_source))
    return false;
  ...
  program_.AttachShader(&geometry_shader_);
  program_.Link();
